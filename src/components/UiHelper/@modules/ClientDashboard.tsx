...
import { TotalNumOfData } from "../utils/chartData/chartDataHandler";
...
const ClientDashboard = () => {
  ...
  const totalClient = TotalNumOfData(clientService);
  return (
    <DashboardPageWrapper>
      <Box>
        <Box>
        ...
        <StartCardWapper>
          <ViewCard count={totalClient} title="Total Clients" />
