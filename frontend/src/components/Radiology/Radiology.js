        ...
        <>
           {user?( <>  
                <div className="level">
                    ...
                    <div className="level-item"> <span className="is-size-6 has-text-weight-medium">List of Radiology </span></div>
             ...
             <>
                {user?( <>  
                     <div className="level">
                         ...
                         <div className="level-item"> <span className="is-size-6 has-text-weight-medium"></span></div>
                         <div className="level-right">
                     { !standalone &&   <div className="level-item"> 
                                 <div className="level-item"><div className="button is-success is-small" onClick={handleCreateNew}>New</div></div>
                             </div>}
